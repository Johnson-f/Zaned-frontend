...
export interface BuiltInStockActionMenuItem {
  symbol: string
}

export function BuiltInStockActionMenu({
  open,
  position,
  selectedItem,
  onClose,
  ...
  selectedItem: BuiltInStockActionMenuItem | null
  onClose: () => void
  ...
  const handleViewInWidget = () => {
    router.push(`/app/charting?symbol=${selectedItem.symbol}`)
    onClose()
  }
